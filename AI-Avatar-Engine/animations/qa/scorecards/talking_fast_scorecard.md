# QA Scorecard — talking_fast

- **Reviewer:** qa
- **Date:** 2026-07-25
- **Review round:** 1 (lip-sync Tier-2 batch, PERC_LOSSLESS+gopsize250)
- **Duration/loop:** 8s
- **Evidence:** previews/talking_fast/ (mp4, strip, stills, meta.json), qa/reports/talking_fast_inspection.png + _metrics.json (inspect_clip: 0 flags), qa/reports/curve_audit_lipsync.json (jaw rhythm/overlap, viseme set, blink schedule, seams).
...
| 3 | Naturalness | 9 | jaw coarticulation overlap = 15% of peak within-phrase (jaw does NOT fully close between adjacent syllables), closes to ~0 only at phrase boundaries. densest cadence (16 peaks/8s), short varied intervals. |
| 4 | Facial aliveness | 9 | expressive speech: jaw amp 0.183 + visemes + brow/mouth accents; distinct per-clip character. |
